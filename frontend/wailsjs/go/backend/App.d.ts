...
import {downloadmgr} from '../models';
...
export function ClearDownloadTasks(arg1:boolean):Promise<void>;
...
export function CreateDownloadTask(arg1:downloadmgr.CreateTaskRequest):Promise<downloadmgr.DownloadTask>;
...
export function GetDownloadTask(arg1:string):Promise<downloadmgr.DownloadTask>;
...
export function ListDownloadTasks(arg1:downloadmgr.ListTaskQuery):Promise<downloadmgr.ListTaskResult>;
